...
def _em_openai_report(dataset: dict, brand_color: str, logo_url: str) -> str:
    ...
    try:
        ...
        out = client.chat.completions.create(
            ...
            messages=[
                {"role":"system","content":"Eres consultor sénior ISO 50001; redacta informe institucional en español con: Resumen, Alcance, Revisión Energética, Línea de Base/EnPIs, Medidas y Ahorros (kWh/año, %, costo, payback), Plan, M&V, Riesgos."},
                {"role":"user","content": f"DATASET JSON:\n{json.dumps(dataset, ensure_ascii=False)}"}
            ]
        )
